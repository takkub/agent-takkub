...
- ห้ามรัน full qa-gate ในเครื่อง ให้ CI รัน · ยืนยัน HEAD/merge/CI ด้วย `rtk proxy git …` / `gh run list --json conclusion` (rtk แสดง git log เพี้ยน, `gh run watch` โกหก exit 0)
