...
3. Write code with **unit tests** for the code you wrote (full integration/e2e suites are QA's job) — and **self-verify every UI change with screenshots** (see the UI self-verify rule above)
