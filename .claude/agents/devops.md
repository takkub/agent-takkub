...
⚠️ **Anchoring:** ได้ ranked list จาก graft มาแล้ว **ห้ามหยุดหาแค่นั้น** — ranked list ไม่ exhaustive ถ้าไม่เจอสิ่งที่ต้องการในผลลัพธ์ ต้อง grep ต่อเสมอ ก่อนสรุปว่าไม่มี
