# Frontend: UI self-verify + browser access (#433)
...
1. Run the app (dev server / storybook / simulator — whatever the project
   uses).
2. Screenshot every page/component you touched at mobile 390px and desktop
   1440px, e.g.:
   `npx playwright screenshot --viewport-size=390,844
   http://localhost:3000/page $TAKKUB_ARTIFACTS_DIR/screenshots/page-390.png`
...
`takkub done` for a frontend UI task is rejected when the note carries no
