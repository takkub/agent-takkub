...
|---|---|---|---|
| [app.py:L19](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/app.py#L19) | Attempts to write `boot.log` into `venv/Lib/runtime/boot.log`. Failing silently on read-only system environments or cluttering internal venv directories. | **Major** | Use `config.RUNTIME_DIR / "boot.log"` (or clone its fallback logic to avoid circular import). |
| [status_header.py:L670](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/status_header.py#L670) | Attempts to write `rtk_button.log` into `venv/Lib/runtime/rtk_button.log`. Failing silently on read-only environments. | **Major** | Use `config.RUNTIME_DIR / "rtk_button.log"`. |
| [issues.py:L204](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/issues.py#L204) | Fallback issues DB is read/written inside `venv/Lib/.takkub_issues.json` when `cockpit_bug=True` (default). Lost on package updates. | **Major** | Use `config.DATA_HOME / ".takkub_issues.json"` as the fallback destination when `cockpit_bug=True`. |
| [spawn_engine.py:L905](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/spawn_engine.py#L905) (also L972, L1018, L1102 & [orchestrator.py:L1518](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/orchestrator.py#L1518)) | Falls back to `REPO_ROOT` (`venv/Lib`) as the working directory when no active project cwd is found, causing Claude panes to start inside `venv/Lib`. | **Major** | Fallback to `os.getcwd()` or `DATA_HOME` instead of `REPO_ROOT`. |
| [cli.py:L554](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/cli.py#L554) (also [skill_audit.py:L55](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/skill_audit.py#L55), L119) | Auditing tools check `.claude/agents` under the current directory instead of using `config.AGENTS_DIR`. Returns empty result or fails. | **Minor** | Resolve `skills_dir` against `config.AGENTS_DIR`. |
| [update_worker.py:L223](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/update_worker.py#L223) | Attempts to write `startup_pull.log` under `REPO_ROOT / "runtime"`. Shielded by `is_git_repo()`, so it exits early, but still incorrect. | **Minor** | Use `config.RUNTIME_DIR / "startup_pull.log"`. |
| [doctor.py:L973](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/doctor.py#L973) | Tells user to click "Enable updates" which doesn't exist on installed builds (they see "Update via npm"). | **Minor** | Check `is_installed_package()` and suggest `npm update -g agent-takkub`. |
| [install.ps1:L385](file:///C:/Users/monch/WebstormProjects/agent-takkub/scripts/install.ps1#L385) | Ignores the user's current clone path and installs into hardcoded `~/WebstormProjects/agent-takkub`. | **Minor** | Resolve `$cockpitDir` dynamically using `$PSScriptRoot\..` (parity with `install.sh`). |
| [cli.py:L694](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/cli.py#L694) | `takkub release` executes `release()` with `REPO_ROOT` which crashes with `FileNotFoundError` (no `pyproject.toml`). | **Benign** | Fail gracefully with a clear message: "takkub release is only available in dev checkouts". |
...
### 1. Boot Log Path
* **File & Line:** [app.py:L19](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/app.py#L19)
* **Code snippet:**
  ```python
...
* **File & Line:** [status_header.py:L670](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/status_header.py#L670)
* **Code snippet:**
  ```python
...
* **File & Line:** [issues.py:L204](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/issues.py#L204)
* **Code snippet:**
  ```python
...
* **Short Fix:** In [issues.py](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/issues.py), use `config.DATA_HOME / ".takkub_issues.json"` for local fallback storage when `cockpit_bug=True` and we are in an installed build.

### 4. Pane Working Directory Fallback
* **File & Line:** [spawn_engine.py:L905](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/spawn_engine.py#L905) (also L972, L1018, L1102 & [orchestrator.py:L1518](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/orchestrator.py#L1518))
* **Code snippet:**
  ```python
...
* **File & Line:** [cli.py:L554](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/cli.py#L554) (also [skill_audit.py:L55](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/skill_audit.py#L55), L119)
* **Code snippet:**
  ```python
...
* **File & Line:** [update_worker.py:L223](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/update_worker.py#L223)
* **Code snippet:**
  ```python
...
* **File & Line:** [doctor.py:L973](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/doctor.py#L973)
* **Code snippet:**
  ```python
...
* **File & Line:** [install.ps1:L385](file:///C:/Users/monch/WebstormProjects/agent-takkub/scripts/install.ps1#L385)
* **Code snippet:**
  ```powershell
...
* **File & Line:** [cli.py:L694](file:///C:/Users/monch/WebstormProjects/agent-takkub/src/agent_takkub/cli.py#L694)
* **Code snippet:**
  ```python
