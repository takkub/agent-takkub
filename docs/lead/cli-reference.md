...
takkub qa-gate --auto                                  # #436: เลือก tier จาก git diff + พิมพ์เหตุผล — style/asset/i18n/md ล้วน = ไม่รัน test เลย (Node: typecheck เท่านั้น) · module logic = targeted tests ที่ map ได้ · api/auth/schema/shared/tooling = full — default ของ specialist ก่อน `takkub done`
